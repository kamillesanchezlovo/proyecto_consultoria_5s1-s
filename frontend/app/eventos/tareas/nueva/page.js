...
/**
 * Devuelve el texto que se mostrará en el <select> de responsables
 * usando los campos que tengamos disponibles del empleado.
 */
...
export default function NuevaTareaPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setMensajeOk("Tarea creada correctamente.");
      setTimeout(() => {
      ...
      <div className="p-6 max-w-3xl mx-auto space-y-4">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Registre una tarea asociada a un evento específico.
          </p>
        </div>
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-slate-400">
                En la interfaz se muestra el nombre, pero internamente se envía
                el ID del empleado, igual que en el admin de Django.
              </p>
            </div>
